...
# 
# nn_net = RSNNS::mlp(x_nn, y_nn, size = c(10, 20 , 10), linOut = TRUE, maxit = 100, learnFuncParams = c(0.002, 0))
...
# RMSE <- sqrt(mean((nnFare - training_data2$Fare)^2))
# sprintf("nn RMSE: %f",RMSE)
